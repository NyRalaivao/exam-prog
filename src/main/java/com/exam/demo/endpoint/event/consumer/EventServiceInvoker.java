package com.exam.demo.endpoint.event.consumer;

import com.exam.demo.PojaGenerated;
import com.exam.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.exam.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.exam.demo.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
